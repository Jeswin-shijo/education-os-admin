...
export const students: Student[] = [
  ...
  { id: 'stu-abin', name: 'Abin Thomas', rollNo: 'CSE21-014', admissionNo: 'ADM2021014', email: 'abin.thomas@campus.edu.in', phone: '+91 98470 12345', program: 'B.Tech', branch: 'CSE', semester: 5, section: 'A', year: 3, cgpa: 8.4, avatarColor: NAVY, mentorName: 'Dr. Rajesh Menon', bloodGroup: 'O+' },
  { id: 'stu-002', name: 'Meera Pillai', rollNo: 'CSE21-002', admissionNo: 'ADM2021002', email: 'meera.pillai@campus.edu.in', phone: '+91 98470 20002', program: 'B.Tech', branch: 'CSE', semester: 5, section: 'A', year: 3, cgpa: 9.1, avatarColor: PURPLE, mentorName: 'Dr. Rajesh Menon', bloodGroup: 'A+' },
  { id: 'stu-003', name: 'Rohan Nair', rollNo: 'CSE21-003', admissionNo: 'ADM2021003', email: 'rohan.nair@campus.edu.in', phone: '+91 98470 20003', program: 'B.Tech', branch: 'CSE', semester: 5, section: 'A', year: 3, cgpa: 7.6, avatarColor: TEAL, mentorName: 'Prof. Anita Nair', bloodGroup: 'B+' },
  { id: 'stu-004', name: 'Anjali Varma', rollNo: 'CSE21-004', admissionNo: 'ADM2021004', email: 'anjali.varma@campus.edu.in', phone: '+91 98470 20004', program: 'B.Tech', branch: 'CSE', semester: 5, section: 'B', year: 3, cgpa: 8.9, avatarColor: PINK, mentorName: 'Prof. Anita Nair', bloodGroup: 'AB+' },
  { id: 'stu-005', name: 'Karthik Suresh', rollNo: 'CSE21-005', admissionNo: 'ADM2021005', email: 'karthik.suresh@campus.edu.in', phone: '+91 98470 20005', program: 'B.Tech', branch: 'CSE', semester: 5, section: 'B', year: 3, cgpa: 6.9, avatarColor: WARNING, mentorName: 'Dr. Rajesh Menon', bloodGroup: 'O-' },
  { id: 'stu-006', name: 'Divya Krishnan', rollNo: 'CSE21-006', admissionNo: 'ADM2021006', email: 'divya.krishnan@campus.edu.in', phone: '+91 98470 20006', program: 'B.Tech', branch: 'CSE', semester: 3, section: 'A', year: 2, cgpa: 8.2, avatarColor: INFO, mentorName: 'Dr. Priya Verghese', bloodGroup: 'A-' },
  { id: 'stu-007', name: 'Vishnu Prasad', rollNo: 'CSE21-007', admissionNo: 'ADM2021007', email: 'vishnu.prasad@campus.edu.in', phone: '+91 98470 20007', program: 'B.Tech', branch: 'CSE', semester: 3, section: 'A', year: 2, cgpa: 7.3, avatarColor: NAVY, mentorName: 'Dr. Priya Verghese', bloodGroup: 'B-' },
  { id: 'stu-008', name: 'Sneha Raj', rollNo: 'ECE21-008', admissionNo: 'ADM2021008', email: 'sneha.raj@campus.edu.in', phone: '+91 98470 20008', program: 'B.Tech', branch: 'ECE', semester: 5, section: 'A', year: 3, cgpa: 8.0, avatarColor: TEAL, mentorName: 'Dr. Meera Iyer', bloodGroup: 'O+' },
  { id: 'stu-009', name: 'Arun Das', rollNo: 'ECE21-009', admissionNo: 'ADM2021009', email: 'arun.das@campus.edu.in', phone: '+91 98470 20009', program: 'B.Tech', branch: 'ECE', semester: 5, section: 'A', year: 3, cgpa: 7.5, avatarColor: PURPLE, mentorName: 'Dr. Meera Iyer', bloodGroup: 'A+' },
  { id: 'stu-010', name: 'Priyanka Joseph', rollNo: 'MECH21-010', admissionNo: 'ADM2021010', email: 'priyanka.joseph@campus.edu.in', phone: '+91 98470 20010', program: 'B.Tech', branch: 'MECH', semester: 5, section: 'A', year: 3, cgpa: 8.6, avatarColor: WARNING, mentorName: 'Dr. Vinod Kumar', bloodGroup: 'B+' },
];
